...
This register concerns inferential limits, not software aesthetics. The complete future program remains in GLOBAL_RESEARCH_ROADMAP.md.
...
| R05 | P1 | No uncertainty around recovery probability, robust effect-size sensitivity or non-administrative survival estimator | Complementary predeclared analysis after primary population is valid | PLANNED |
| R06 | P1 | Mechanism attribution limited to node-only/edge-only and structured SW-UCB | Full ablations and shared-state non-MG comparisons with matched tuning budgets | PARTIAL |
| R07 | P1 | Novelty and literature coverage are not established | Read and cite primary literature across every family in prompt §70; overlap/difference matrix | PLANNED; no novelty claim |
| R08 | P2 | One complete layered DAG family, one abrupt shock, one clipped-Gaussian observation contract | Unseen topology, rho/magnitude, heavy-tail, drift, repeated/delayed/missing-feedback experiments | OPEN |
| R09 | P1 | Threshold-based recovery may already be satisfied immediately after shock | Inspect pilot floor/ceiling effects without tuning; change metric only in a new, transparently versioned protocol | OPEN |
| R10 | P3 | No real provider traces/workloads, costs or live validation | Licensed sanitized traces, immutable provenance, replay and bounded live canary | PLANNED |
